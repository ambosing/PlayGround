...
train_dir = os.path.join('/content/gdrive/My Drive/train')
test_dir = os.path.join('/content/gdrive/My Drive/test')
...
scores = resnet50.evaluate_generator(test_generator, steps=18)
print("%s : %.2f%% \n\n" % (resnet50.metrics_names[1], scores[1] * 100))

out = resnet50.predict_generator(test_generator, steps=18)
